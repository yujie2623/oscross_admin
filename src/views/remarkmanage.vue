<template>
  <div class="newslist" style="padding:50px 20px">
    <el-table :data="items.list" stripe style="width: 100%" height="580" border>
      <el-table-column prop="name" label="用户名" min-width="180" align="center" show-overflow-tooltip />
      ...
      <el-table-column prop="content" label="留言" min-width="180" align="center" show-overflow-tooltip />
...
import { getMsglist } from '@/api/admin'
export default {
  setup() {
